        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 max-w-6xl w-full">
          ...
          <div className="w-full lg:w-1/2 text-white border bg-purple-950 border-white p-6 backdrop-blur-sm">
            ...
            <div className="flex flex-wrap gap-4">
              <button
                className="bg-transparent text-white font-bold py-2 px-4 border border-white hover:bg-purple-600 transition"
                onClick={() =>
                  window.open(
              ...
              <button
                className="bg-transparent text-white font-bold py-2 px-4 border border-white hover:bg-orange-400 transition"
                onClick={() =>
                  window.open(
